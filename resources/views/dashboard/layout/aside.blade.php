                    ...
                    <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                        ...
                        <div class="menu-submenu">
                            ...
                            <ul class="menu-subnav">
                                @can('edit Terms and Conditions For User')
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="" class="menu-link">
                                ...
                                @can('edit privacy policy For User')
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="" class="menu-link">
                                            <i class="menu-bullet menu-bullet-line">
                                                <span></span>
                                ...
                                @can('edit privacy policy For Worker')
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="" class="menu-link">
                                            <i class="menu-bullet menu-bullet-line">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">{{__('aside.privacy_policy_worker')}}</span>
                                        </a>
                                    </li>
                                @endcan

                                @can('edit Terms and Conditions For Worker')
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="" class="menu-link">
                                            <i class="menu-bullet menu-bullet-line">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">{{__('aside.terms_and_conditions_worker')}}</span>
                                        </a>
                                    </li>
                                @endcan
